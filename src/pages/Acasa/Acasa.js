          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-44">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="/servicii"
                  className="rounded-md bg-accent-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-accent-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Află mai multe
                </a>
